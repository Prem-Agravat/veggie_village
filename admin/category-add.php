...
<div class="content">
	...
	<div>
		<h3 style="padding-top:35px;">Add Categories</h3>
	</div>
    ...
    <div class="center" style="padding: 40px;margin:20px;">
        ...
        <form action="../backends/admin/cat-add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col s6" style="">
                            <div class="input-field">
                            <input id="short_desc" name="short_desc" type="text" class="validate" style="width: 70%">
            ...
            <div class="row">
                ...
                <div class="input-field">
                <input id="long_desc" name="long_desc" type="text" class="validate" style="width: 70%">
            ...
            <div class="row">
                ...
                <div class="input-field">
                <input id="img" name="img" type="file" class="validate" style="color: black;border-radius:10px;">
