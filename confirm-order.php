...
<form action="backends/order-food.php?id=<?php echo $arr_all['id']; ?>" method="post" enctype="multipart/form-data" style="height:auto;margin-bottom:20px;">
    <div>
        ...
        <label>Offer Applied Successfully!</label>
    </div>
        <?php 
if ($row > 0) { ?>
<div id="offerdiv">
<br><label style="color: black;"><b>Select Offers :</b></label>
    ...
    <div>
        ...
        <label id="codelable" style="color:red;"></label><br>
...
<?php } ?>
            ...
            <div class="btn-container">
                ...
                <button type="submit" class="order-btn" id="order-confirm-btn">Confirm Order</button>
            </div>
        </div>
    </div>
</form>
